...
export default function SlimTaskRow({ task, onEdit, onDelete, onArchive }) {
    ...
    <tr className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
      ...
      <td className="pl-3 pr-4 py-1.5 whitespace-nowrap">
        <div className="flex items-center gap-1">
          ...
          <button onClick={() => onEdit(task.id)} className="p-1 text-gray-400 hover:text-blue-600 rounded hover:bg-blue-50 transition-colors" title="Edit">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
